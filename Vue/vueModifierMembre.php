        ...
        <div class="col-md-8 blog-main" >
            ...
            <div class="container">
                ...
                ?>
                    ...
                    <form  <?php if (isset($membre['id']) && $membre['id']) ?> action="<?= 'index.php?action=modifMembre&id=' . $membre['id'] ?>" method="post" >
                        <div class="form-group"> 
                            ...
                            <br/>
                                <input class="form-control" name="pseudo" id="pseudo" type="text" <?php if (isset($membre['id']) && $membre['id']) ?>value="<?= nl2br(htmlspecialchars($membre['pseudo']));?>"  required>
                            </div>
                            <br/>
                            ...
                            <br/>
                                <input class="form-control" name="pass" id="pass" type="text" <?php if (isset($membre['id']) && $membre['id']) ?>value="" Placeholder="Entrez votre nouveau mot de passe ..."required>
                            </div>
                            <br/>
                            <div class="form-group">
                            <label for="mail"><strong>Mail : </strong></label>
                            <br/>
                                <input class="form-control" name="mail" id="mail" type="email"  <?php if (isset($membre['id']) && $membre['id']) ?>value="<?= nl2br(htmlspecialchars($membre['mail']));?>" required>
                            </div>
                            <br/>
                            <br/>
